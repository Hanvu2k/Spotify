...
export default function Info() {
  ...
  return (
    <div className={`info ${!isOpen && "hidden"}`} style={{ width: "364px" }}>
              ...
              <div className="artist-song_info p-[16px]">
                ...
                <div className="artist-description">
                  <p>
                    ...
                    global smashes "Peaches feat. Daniel Caesar & Giveon",
                    “Holy” feat. Chance The Rapper, “Lonely” feat. Benny Blanco,
                    ...
                    guest twice on Saturday Night Live, performed on The
                    American Music Awards, The People’s Choice Awards, and much
                    more. With over 86 billion career streams and over 78
                    million albums sold worldwide, Justin Bieber continues to
                    reign as one of the biggest artists in the world. Bieber is
                    the #1 artist on Spotify with over 75 million monthly
                    listeners!
                  </p>
                </div>
              </div>
